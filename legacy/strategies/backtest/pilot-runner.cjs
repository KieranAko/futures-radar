...
const { buildStrategyPlan, validatePlan } = require('../../../analysis/strategy/strategy-matcher.cjs');
const { recordExecutablePlans, verifyPlans } = require('../../../analysis/strategy/feedback.cjs');
