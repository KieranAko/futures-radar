// stories/lib/story-indicators.cjs — 传导链节点指标计算器（数据哨兵）
//
...
const macroHistory = require('../../storage/macro-history-builder.cjs');
...
// 板块指数（与 collection/sector-aggregator.cjs 同口径：等权日收益链式，基点 1000）
