#!/usr/bin/env node
/**
 * analysis/sector-driver-lib.cjs — 板块驱动 LLM 的共享库（v0.1.5）
 *
 * 原则：
...
const PROMPT_TEMPLATE = path.join(skillRoot, 'legacy', 'reasoning', 'reasoning', 'prompts', 'sector-driver-prompt.md');
