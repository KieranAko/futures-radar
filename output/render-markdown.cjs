...
const { renderFreshnessCard } = require('../analysis/assembly/freshness.cjs');
...
// 成本锚快照（由文件库主档投影，见 analysis/v2/cost-anchor/；缺失时行内不展示）
...
const { planStateOf, planReasonsOf, eventLabel } = require('../shared/strategy-state.cjs');
