 ...
 *
 * CLI：
 *   node storage/index.cjs --init
 *   node storage/index.cjs --seed
 *   node storage/index.cjs --verify
 *   node storage/index.cjs --stats
 *   node storage/index.cjs --export
 *   node storage/index.cjs --compact [--symbol RB0]
 */
...
// ── CLI ─────────────────────────────────────────────────────
function printUsage() {
  console.log('Usage: node storage/index.cjs --init|--seed|--verify|--stats|--export|--compact [--symbol SYM]');
  console.log('       node storage/index.cjs --cost-anchor-stats|--cost-anchor-verify');
}
